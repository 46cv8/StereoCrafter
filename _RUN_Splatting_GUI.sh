...
export STEREOCRAFTER_LOGLEVEL=DEBUG   # only matters if you add env support in python; harmless otherwise

# Optionally force consistent ffprobe output regardless of locale
export LC_ALL=C
export LANG=C

# Run splatting_gui.py with logging forced to DEBUG (no code changes needed)
exec "$PYTHON" - <<'PY'
...
runpy.run_path("splatting_gui.py", run_name="__main__")
PY

# exec "$PYTHON" splatting_gui.py
